...
本記事の主測定はMTPLX 2.9.0で取得した歴史記録です。現在のリポジトリ基本構成はMTPLX 2.11.3 / MLX 0.32.2 / transformers 5.12.1へ更新されています。最新版の再測定結果は[`M1_MAX_OPTIMIZATION_REPORT.md`](../M1_MAX_OPTIMIZATION_REPORT.md)と生データに分離して記録しています。
