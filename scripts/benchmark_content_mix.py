...
def sanitize(data: dict, client_wall_s: float, content: dict, run: int, mode: str, depth: int) -> dict:
    ...
    return {
        ...
        "prompt_mtp_history_tok_s": stats.get("prompt_mtp_history_tok_s"),
        ...
        # Optional MTPLX flight-recorder timings. Missing values remain None;
        # the harness must never infer unavailable sub-times from totals.
        "draft_time_s": stats.get("draft_time_s"),
        "verify_time_s": stats.get("verify_time_s"),
        "target_forward_time_s": stats.get("target_forward_time_s"),
        "verify_forward_time_s": stats.get("verify_forward_time_s"),
        "verify_eval_time_s": stats.get("verify_eval_time_s"),
        "accept_time_s": stats.get("accept_time_s"),
        "commit_time_s": stats.get("commit_time_s"),
        "capture_commit_time_s": stats.get("capture_commit_time_s"),
        "correction_time_s": stats.get("correction_time_s"),
        "repair_time_s": stats.get("repair_time_s"),
        "bonus_time_s": stats.get("bonus_time_s"),
        "lazy_bonus_commit_time_s": stats.get("lazy_bonus_commit_time_s"),
        "snapshot_time_s": stats.get("snapshot_time_s"),
        "rollback_time_s": stats.get("rollback_time_s"),
